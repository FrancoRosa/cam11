...
CLASSES = ("person", "bicycle", "car","motorbike","aeroplane","bus","train","truck","boat","traffic light",
           ...
           "oven","toaster","sink","refrigerator","book","clock","vase","scissors","teddy bear","hair drier", "toothbrush", "pile")
...
if __name__ == '__main__':
    ...
    # basic params
    parser.add_argument('--model_path', type=str, required= False, default="/home/luckfox/rknn_model_zoo/examples/yolo11/model/yolo11.rknn", help='model path, could be .pt or .rknn file')
